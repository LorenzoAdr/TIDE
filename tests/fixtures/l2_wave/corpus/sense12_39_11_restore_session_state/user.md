...
1. [en_curso] A locator: dónde se restaura la posición del cursor al abrir el proyecto
2. [pendiente] B locator: dónde se restauran los paneles laterales al abrir el proyecto
3. [pendiente] P puente: hay camino restaurar el cursor y restaurar los paneles laterales (need A B)
