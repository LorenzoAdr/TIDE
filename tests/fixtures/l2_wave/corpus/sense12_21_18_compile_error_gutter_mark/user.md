...
1. [en_curso] A locator: dónde se extraen la línea y columna de los errores de compilación del texto de la consola
2. [pendiente] B locator: dónde se dibuja una línea roja en el margen izquierdo del editor para marcar un error
3. [pendiente] P puente: hay camino el análisis del error de compilación y el dibujo de la línea roja en el margen (need A B)
...
no encontré el mecanismo que extrae línea y columna de errores de compilación; lo leído solo procesa errores de linker undefined reference y no hay evidencia de un parser de errores de compilación gcc clang en el sistema
Abierto:
...
T1 preguntó:
dónde se extraen la línea y columna de los errores de compilación del texto de la consola
Cerrado de T1:
...
Legal ahora: no_pasar, revisar, explorar, plan, cerrar
