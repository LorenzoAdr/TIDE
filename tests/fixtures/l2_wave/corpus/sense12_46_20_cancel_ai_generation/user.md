...
1. [en_curso] A locator: dónde se captura el clic fuera para cancelar la generación de la IA
2. [pendiente] B locator: dónde se revierten los cambios en el archivo al cancelar la generación
...
T4 preguntó:
dónde se captura el clic fuera para cancelar la generación de la IA
Cerrado de T4:
leído: handle ai console keys, cancel current
