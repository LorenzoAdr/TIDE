...
no encontré la interceptación de la tecla Escape ni el clic fuera para cancelar la generación de la IA; lo leído es una función de escape de caracteres en strings ai trace escape y una función de cancelación de nivel 1 cancel level1 que no muestra el disparador de UI
Abierto:
...
T1 preguntó:
dónde se intercepta la tecla Escape o el clic fuera para cancelar la generación de la IA
Cerrado de T1:
ESA pregunta no se relanza. Si el ancla era esa pregunta, cierra el claim citando lo leído. Si el ancla pedía más, amplia otro keep o un hop del pack; no refutes el claim entero.
no encontré la interceptación de la tecla Escape ni el clic fuera para cancelar la generación de la IA; lo leído es una función de escape de caracteres en strings ai trace escape y una función de cancelación de nivel 1 cancel level1 que no muestra el disparador de UI
...
Esa pregunta ya tiene respuesta (no hay objeto). No la relances. PROHIBIDO plan u otro explorar con el mismo claim. do=cerrar citando lo leído. Ya se tiró: «dónde se intercepta la tecla Escape o el clic fuera para cancelar la generación de la IA». Rechazado: dónde se llama a la cancelación de la generación de IA al pulsar Escape o hacer clic fuera
