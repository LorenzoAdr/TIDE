...
luz (calibración del piloto; no copies): cursor, blink, kubernetes, quantum, vector, physics, trajectory
plano (calor del ancla; no copies nombres ni ids):
  ui ●●●  ai_missing_toast ai_path_scope_modal ai_transcript_view binary_symbols_panel bindings_store busy_strip  habla: editor, util, ai, parser
  ...
  ai ●  action_json ai_packages ai_path_scope ai_trace ai_types coding_stem_embed_index  habla: ui, editor, util, parser
  parser ●  tree_sitter_ast_utils tree_sitter_completion tree_sitter_highlight tree_sitter_language tree_sitter_service tree_sitter_symbols  habla: editor, util, symbols, lsp
  symbols ●  call_hierarchy code_action completion_snippet hover_info source_symbol_resolver symbol_kind  habla: editor, util, parser, indexer
  app ·  app_mode debug_model editor_tabs language_override workspace_detect workspace_session  habla: ui, editor, util, ai
...
zoom editor (stems; no copies ids):
  ...
  helix_dispatch  helix text_object_context ctx helix_dispatch  habla: text_ops, editor_state, text_search, completion_snippet
  ...
  bracket_match  bracket_match find_bracket_pair_highlight find_colored_curly_braces find_enclosing_block_comment  habla: editor_state, editor_buffer_source, tree_sitter_document, tree_sitter_service
...
zoom ui (stems; no copies ids):
  text_input_style  blink focused in_sel option  habla: theme, cursor_blink, cursor_blink_ui, raw_pty_screen
  watches_panel  breakpoint_rows flat_watches khardware breakpoint_hw_input_active  habla: text_input_style, theme, text_ops, app_mode
  theme  syntax g_overrides code_bg has_ui_color_overrides  habla: symbol_kind, tr
  editor_panel  code_box all_items lsp_inflight_key lsp_pending_key  habla: text_input_style, theme, text_ops, editor_state
  search_panel  query_option search_panel search_query_has_selection cancelled  habla: text_input_style, theme, text_ops, cursor_blink
  git_panel  entry_index commits ktabbranches ktablog  habla: text_input_style, theme, cursor_blink, busy_strip
  cursor_blink  cursor_blink effective_col khalfperiodms kidlebeforeblinkms
  binary_symbols_panel  binary_symbols_panel filter_runner loading binding_filter  habla: text_input_style, theme, cursor_blink, clickable
  … +76 stems
  cached: watches_panel, editor_panel
  byte: text_input_style, glyphs
  content: text_input_style, settings_modal
