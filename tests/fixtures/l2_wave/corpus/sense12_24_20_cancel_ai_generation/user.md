...
no encontré la captura de la tecla Escape para cancelar la generación de IA; lo leído es ai trace escape que es una función de escape de caracteres JSON backslashes, no un handler de teclado.
Abierto:
...
Esa pregunta ya tiene respuesta (no hay objeto). No la relances. PROHIBIDO plan u otro explorar con el mismo claim. do=cerrar citando lo leído. Ya se tiró: «dónde se captura la tecla Escape para cancelar la generación de la IA». Rechazado: dónde se captura el clic fuera para cancelar la generación de la IA
