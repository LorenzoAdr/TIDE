...
1. [fallo] A locator: dónde se guarda y restaura la lista de archivos abiertos al reabrir un proyecto
2. [en_curso] B locator: dónde se guarda y restaura la visibilidad de los paneles laterales al reabrir un proyecto (hacia layout)
...
Preguntó: dónde se guarda y restaura la lista de archivos abiertos al reabrir un proyecto
...
### Trabajo 3
consulta: dónde se guarda y restaura la visibilidad de los paneles laterales al reabrir un proyecto
keep: M2
leído: (nada)
Cerrado:
El hijo cerró esta pregunta: no hay objeto. Está contestada. No se relanza.
Preguntó: dónde se guarda y restaura la visibilidad de los paneles laterales al reabrir un proyecto
ESA pregunta no se relanza. Cierra ESE mapeo, o un objeto distinto del pack (un extra del Abierto); no el mismo claim en otro keep; no refutes el claim entero.
(vacío)
Abierto:
(nada; no copiar ids del pack)
...
T2 preguntó:
dónde se guarda y restaura la lista de archivos abiertos al reabrir un proyecto
Cerrado de T2:
El hijo cerró esta pregunta: no hay objeto. No se relanza.
(vacío)

T3 preguntó:
dónde se guarda y restaura la visibilidad de los paneles laterales al reabrir un proyecto
Cerrado de T3:
El hijo cerró esta pregunta: no hay objeto. No se relanza.
(vacío)
