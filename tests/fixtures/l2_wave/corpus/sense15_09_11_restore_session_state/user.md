...
1. [fallo] A locator: dónde se restaura la posición del cursor al abrir un archivo (hacia set cursor position)
2. [en_curso] B locator: dónde se restaura la visibilidad de los paneles laterales al abrir el proyecto (hacia panel)
3. [pendiente] P puente: hay camino restaurar el cursor y restaurar los paneles (need A B)
