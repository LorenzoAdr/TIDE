...
1. [fallo] A locator: dónde se restaura la posición del cursor al volver a abrir un proyecto
2. [en_curso] B locator: dónde se restauran los archivos abiertos al volver a abrir un proyecto
3. [pendiente] C locator: dónde se restaura la visibilidad de los paneles laterales al volver a abrir un proyecto
4. [pendiente] P puente: hay camino restaurar el cursor, los archivos y los paneles al abrir el proyecto (need A B C)
...
T1 preguntó:
dónde se restaura la posición del cursor y los archivos abiertos al volver a abrir un proyecto
Cerrado de T1:
leído: Cursor Pos, editor state hpp

T2 preguntó:
dónde se restaura la posición del cursor al volver a abrir un proyecto
Cerrado de T2:
leído: Cursor Pos, editor state hpp, set primary, reset to single cursor
