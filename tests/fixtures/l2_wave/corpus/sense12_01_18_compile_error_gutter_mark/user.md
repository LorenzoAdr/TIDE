...
1. [fallo] A locator: dónde se dibuja la línea roja en el margen del editor para marcar un error
2. [fallo] B locator: dónde se extraen los errores de compilación del texto de la consola
3. [pendiente] P puente: hay camino extraer el error de la consola y dibujar la marca en el editor (need A B)
