...
1. [fallo] A locator: dónde se guarda y restaura la visibilidad de los paneles laterales al abrir un proyecto
2. [en_curso] B locator: dónde se guarda y restaura la posición del cursor al abrir un proyecto
3. [pendiente] C locator: dónde se guarda y restaura la lista de archivos abiertos al abrir un proyecto
4. [pendiente] P puente: hay camino restaurar paneles, cursor y archivos abiertos (need A B C)
...
T1 preguntó:
dónde se guarda y restaura la posición del cursor y los archivos abiertos al volver a abrir un proyecto
Cerrado de T1:
