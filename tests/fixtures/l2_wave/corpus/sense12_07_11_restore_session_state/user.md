...
1. [en_curso] A locator: dónde se guarda el estado de los paneles laterales al cerrar la sesión
2. [pendiente] B locator: dónde se restauran los paneles laterales al abrir la sesión
3. [pendiente] P puente: hay camino guardar y restaurar el estado de los paneles laterales (need A B)
...
T3 preguntó:
dónde se restaura la selección del cursor al abrir un archivo
Cerrado de T3:
encontré el mecanismo de restauración: al abrir un archivo, open file at impl disparo invoca a reset to single cursor efecto sobre el buffer del editor, estableciendo la posición del cursor en la línea y columna proporcionadas.

T4 preguntó:
dónde se guarda el estado de los paneles laterales al cerrar la sesión
Cerrado de T4:
