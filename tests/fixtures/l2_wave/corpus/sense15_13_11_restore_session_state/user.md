...
1. [fallo] A locator: dónde se guarda la posición del cursor y los archivos abiertos al salir del proyecto
2. [en_curso] B locator: dónde se restaura la posición del cursor y los archivos abiertos al entrar al proyecto
3. [pendiente] C locator: dónde se guarda y restaura la visibilidad de los paneles laterales al cerrar y abrir el proyecto
4. [pendiente] P puente: hay camino guardar restaurar cursor archivos y guardar restaurar paneles laterales (need A B C)
...
T2 preguntó:
dónde se guarda la posición del cursor y los archivos abiertos al salir del proyecto
Cerrado de T2:
ESA pregunta no se relanza. Lo leído no era el disparo. PROHIBIDO el mismo claim. do=cerrar ese mapeo. Si el ancla pedía más, un objeto distinto del pack; no el mismo claim en otro keep; no refutes el claim entero.
leído: save, config path, save workspace session, flush active tab

T3 preguntó:
dónde se restaura la posición del cursor y los archivos abiertos al entrar al proyecto
Cerrado de T3:
ESA pregunta no se relanza. Lo leído no era el disparo. PROHIBIDO el mismo claim. do=cerrar ese mapeo. Si el ancla pedía más, un objeto distinto del pack; no el mismo claim en otro keep; no refutes el claim entero.
leído: reload stale tabs from disk
