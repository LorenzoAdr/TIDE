...
1. [fallo] A locator: dónde se extrae la línea de error del texto de la consola inferior
2. [en_curso] B locator: dónde se dibuja la línea roja en el margen del editor (hacia visual highlight)
3. [pendiente] P puente: hay camino extraer la línea del error y dibujar la marca roja (need A B)
