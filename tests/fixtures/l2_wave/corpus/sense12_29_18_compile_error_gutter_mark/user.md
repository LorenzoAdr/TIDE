...
1. [en_curso] A locator: dónde se parsean los errores de compilación del texto de la consola para obtener la línea y el mensaje
2. [pendiente] B locator: dónde se crea el marcador de diagnóstico en el margen del editor a partir de un error
3. [pendiente] P puente: hay camino el parser de errores de la consola y el creador de marcadores del editor (need A B)
...
T4 preguntó:
dónde se parsean los errores de compilación del texto de la consola para obtener la línea y el mensaje
Cerrado de T4:
El hijo cerró esta pregunta: no hay objeto. No se relanza.
(vacío)
