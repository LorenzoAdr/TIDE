...
2. [paso] B locator: dónde se restauran los archivos abiertos al volver a un proyecto
3. [en_curso] C locator: dónde se restaura la visibilidad de los paneles laterales al abrir un proyecto
...
T2 preguntó:
dónde se restauran los archivos abiertos al volver a un proyecto
Cerrado de T2:
encontré el mecanismo: restore workspace session lee load y itera session open tabs llamando a workspace open file path para cada archivo existente; se dispara desde set workspace y el constructor Application.
