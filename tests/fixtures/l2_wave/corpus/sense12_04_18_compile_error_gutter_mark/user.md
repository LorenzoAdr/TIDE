...
1. [paso] A locator: dónde se leen los errores de compilación de la consola inferior
2. [en_curso] B locator: dónde se dibuja la línea roja en el margen izquierdo del editor (hacia visual highlight)
3. [pendiente] P puente: hay camino leer el error y dibujar la línea roja (need A B)
