...
1. [fallo] A locator: dónde se guarda y restaura la posición del cursor al cerrar y abrir un proyecto
2. [en_curso] B locator: dónde se guarda y restaura la lista de archivos abiertos al cerrar y abrir un proyecto
3. [pendiente] C locator: dónde se guarda y restaura la visibilidad de los paneles laterales al cerrar y abrir un proyecto
...
T2 preguntó:
dónde se guarda y restaura la posición del cursor al cerrar y abrir un proyecto
Cerrado de T2:
leído: Cursor Pos

T3 preguntó:
dónde se guarda y restaura la lista de archivos abiertos al cerrar y abrir un proyecto
Cerrado de T3:
...
El plan son 2–4 fases (locator / puente / seguir), no un locator por cada objeto del ancla. Recorta a 2–4 o lanza un explorar del fenómeno. Si este plan fue rechazado, el siguiente tiro es explorar, no otro plan. El runtime no redacta la consulta.
