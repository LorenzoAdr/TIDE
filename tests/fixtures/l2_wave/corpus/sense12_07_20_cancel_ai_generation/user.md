...
Esa pregunta ya tiene respuesta (no hay objeto). No la relances. Cierra el claim si basta lo acumulado, o formula otra pregunta. Ya se tiró: «dónde se captura la tecla Escape o el clic fuera para cancelar la generación de la IA». Rechazado: dónde se captura el clic fuera del editor para cancelar la generación de la IA
