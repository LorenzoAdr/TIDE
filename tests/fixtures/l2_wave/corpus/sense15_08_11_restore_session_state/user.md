...
1. [fallo] A locator: dónde se guarda y restaura la lista de archivos abiertos al volver a abrir un proyecto
2. [en_curso] B locator: dónde se guarda y restaura la visibilidad de los paneles laterales al volver a abrir un proyecto
3. [pendiente] P puente: hay un mecanismo común que restaura archivos y paneles juntos al abrir un proyecto (need A B)

Trabajos ya hechos:
### Trabajo 1
consulta: dónde se guarda y restaura la posición del cursor al abrir un proyecto
keep: M7 M8
leído: editor state cpp, recent projects cpp
Cerrado:
leído: editor state cpp, recent projects cpp
Abierto:
...
T1
    visto: editor state cpp, recent projects cpp
