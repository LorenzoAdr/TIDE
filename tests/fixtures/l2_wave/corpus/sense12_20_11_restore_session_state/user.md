...
1. [en_curso] A locator: dónde se guarda el estado de visibilidad de los paneles laterales al cerrar el proyecto
2. [pendiente] B locator: dónde se restaura la visibilidad de los paneles laterales al abrir el proyecto (hacia panel)
...
T4 preguntó:
dónde se guarda el estado de visibilidad de los paneles laterales al cerrar el proyecto
Cerrado de T4:
leído: serialize ai settings
