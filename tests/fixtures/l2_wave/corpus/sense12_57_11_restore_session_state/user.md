...
1. [paso] A locator: dónde se guarda el estado del editor al cerrar el proyecto
2. [en_curso] B locator: dónde se restaura el estado del editor al abrir el proyecto
3. [pendiente] P puente: hay camino guardar y restaurar el estado del editor (need A B)
...
T2 preguntó:
dónde se restaura el estado del editor al abrir el proyecto
Cerrado de T2:
...
Esta pregunta ya tiene respuesta (no hay objeto). No la relances ni en otro keep. Cierra ESE mapeo, o un objeto distinto del pack (un extra del Abierto); no el mismo claim en otro keep; no refutes el claim entero. Ya se tiró: «dónde se restaura el estado del editor al abrir el proyecto». Rechazado: dónde se restaura el estado del editor al abrir el proyecto
