...
keep: M1
leído: line gutter marker, fold gutter marker
Cerrado:
leído: line gutter marker, fold gutter marker
Abierto:
...
### Trabajo 2
consulta: dónde se extraen los errores de compilación del texto de la consola para crear marcadores en el editor
keep: M11
leído: (nada)
Cerrado:
El hijo cerró esta pregunta: no hay objeto. Está contestada. No se relanza.
Preguntó: dónde se extraen los errores de compilación del texto de la consola para crear marcadores en el editor
...
T1
    visto: line gutter marker, fold gutter marker
...
T2 preguntó:
dónde se extraen los errores de compilación del texto de la consola para crear marcadores en el editor
Cerrado de T2:
