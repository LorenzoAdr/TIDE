...
2. [en_curso] B locator: dónde se limpia el archivo o se deshace la inserción parcial al cancelar la generación
3. [pendiente] P puente: hay camino capturar el Escape y limpiar el archivo al cancelar (need A B)
...
T2 preguntó:
dónde se limpia el archivo o se deshace la inserción parcial al cancelar la generación
Cerrado de T2:
