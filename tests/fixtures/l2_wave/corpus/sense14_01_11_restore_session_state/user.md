...
1. [paso] A locator: dónde se guarda y restaura la lista de archivos abiertos al cerrar y abrir el proyecto
2. [en_curso] B locator: dónde se guarda y restaura la visibilidad de los paneles laterales al cerrar y abrir el proyecto
...
T1 preguntó:
dónde se guarda y restaura la posición del cursor al abrir el proyecto
Cerrado de T1:
