...
1. [en_curso] A locator: dónde se maneja la entrada del usuario para cancelar la generación de IA
2. [pendiente] B locator: dónde se maneja la ruta para cancelar la generación de IA
3. [pendiente] P puente: hay camino manejar la entrada del usuario y cancelar la generación de IA (need A B)
...
T2 preguntó:
dónde se cancela la generación de la IA al hacer clic fuera del editor
Cerrado de T2:
leído: cancel current, cancel level1

T3 preguntó:
dónde se maneja la entrada del usuario para cancelar la generación de IA
Cerrado de T3:
leído: handle ai console keys, cancel level1, cancel current, clear pending insert, handle user input

La última caza cerró. El siguiente tiro es un port del pack (entre abiertas / extra), no el ancla ni el mismo keep.

Legal ahora: pasar, cerrar
