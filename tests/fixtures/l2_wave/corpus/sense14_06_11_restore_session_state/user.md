...
3. [pendiente] C locator: dónde se guarda y restaura la lista de archivos abiertos
4. [pendiente] D locator: dónde se guarda y restaura el estado de los paneles laterales
