...
2. [fallo] B locator: dónde se limpia el archivo a medias al cancelar la generación de la IA
3. [pendiente] P puente: hay camino capturar la cancelación y limpiar el archivo a medias (need A B)
...
Esa pregunta ya se contestó. do=cerrar ese mapeo. PROHIBIDO plan u otro explorar del mismo objeto. Ya se tiró: «dónde se limpia el archivo a medias al cancelar la generación de la IA». Rechazado: dónde se captura la pulsación de Escape o el clic fuera para cancelar la generación de la IA
