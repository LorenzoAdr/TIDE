...
1. [fallo] A locator: dónde se detecta el clic fuera del editor para cancelar la generación de la IA
2. [en_curso] B locator: dónde se limpia el archivo a medias al cancelar la generación de la IA (hacia clear pending insert)
...
T2 preguntó:
dónde se detecta el clic fuera del editor para cancelar la generación de la IA
Cerrado de T2:
