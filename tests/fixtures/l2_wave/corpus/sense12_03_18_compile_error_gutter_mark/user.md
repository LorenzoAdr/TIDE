...
1. [paso] A locator: dónde se extraen la línea y columna de los errores de compilación del texto de la consola
2. [en_curso] B locator: dónde se dibuja una línea roja en el margen izquierdo del editor para marcar un error
3. [pendiente] P puente: hay camino el parser de errores de la consola y el dibujo de la línea roja en el margen (need A B)
