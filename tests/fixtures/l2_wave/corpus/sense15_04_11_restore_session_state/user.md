...
1. [en_curso] A locator: dónde se guarda y restaura la lista de archivos abiertos al cerrar y abrir el proyecto
2. [pendiente] B locator: dónde se guarda y restaura la visibilidad de los paneles laterales al cerrar y abrir el proyecto
...
T2 preguntó:
dónde se guarda la posición del cursor en el editor al cerrar el proyecto
Cerrado de T2:
