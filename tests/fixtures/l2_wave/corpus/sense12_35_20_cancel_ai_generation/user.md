...
no encontré la captura de la tecla Escape para cancelar la generación; lo leído es ai trace escape, que escapa caracteres para JSON y no maneja eventos de teclado
Abierto:
- handle key event
- cancel generation
...
Esa pregunta ya se contestó. do=cerrar ese mapeo. PROHIBIDO plan u otro explorar del mismo objeto. Ya se tiró: «dónde se captura la tecla Escape para cancelar la generación de código».
