...
1. [en_curso] A locator: dónde se restaura la visibilidad de los paneles laterales al reabrir el proyecto
2. [pendiente] B locator: dónde se guarda la visibilidad de los paneles laterales al cerrar el proyecto
...
T3 preguntó:
dónde se restaura la lista de archivos abiertos al reabrir el proyecto
Cerrado de T3:
leído: open file at impl, load buffer from disk

T4 preguntó:
dónde se restaura la visibilidad de los paneles laterales al reabrir el proyecto
Cerrado de T4:
leído: Ai Controller
