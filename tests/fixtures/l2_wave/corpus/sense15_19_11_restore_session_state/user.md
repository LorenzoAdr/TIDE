...
3. [pendiente] C locator: dónde se guarda la lista de archivos abiertos al cerrar el proyecto
4. [pendiente] D locator: dónde se restaura la lista de archivos abiertos al abrir el proyecto
