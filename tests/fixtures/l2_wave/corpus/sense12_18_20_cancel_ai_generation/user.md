...
Esa pregunta ya tiene respuesta (no hay objeto). No la relances. PROHIBIDO plan u otro explorar con el mismo claim. do=cerrar citando lo leído. Ya se tiró: «dónde se captura la tecla Escape o el clic fuera para cancelar la generación de la IA». Rechazado: dónde se intercepta la tecla Escape en el panel de edición para abortar la acción en curso
