...
3. [pendiente] P puente: hay camino capturar la interrupción y limpiar el archivo a medias (need A B)
...
Esa pregunta ya se contestó. do=cerrar ese mapeo. PROHIBIDO plan u otro explorar del mismo objeto. Ya se tiró: «dónde se limpia el archivo parcialmente escrito al cancelar la generación de la IA». Rechazado: dónde se captura la pulsación de Escape o el clic fuera para interrumpir la generación de la IA
