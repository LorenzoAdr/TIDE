...
zoom ai (stems; no copies ids):
  ...
  l2_wave  candidatas cerrar encurso locus_keys_match  habla: l2_cerca_wake, action_json, get_code_of, key_binding_registry
...
T2 preguntó:
dónde se limpia o revierte el archivo que se está escribiendo a medias al cancelar la IA
Cerrado de T2:
leído: clear pending insert, cancel current, cancel all, busy, cancel level1, begin insert at, handle user input
