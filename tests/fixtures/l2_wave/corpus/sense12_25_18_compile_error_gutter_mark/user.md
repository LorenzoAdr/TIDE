...
1. [en_curso] A locator: dónde se leen los errores de compilación de la consola inferior para añadirlos a los diagnostics del editor
2. [pendiente] B locator: dónde se marcan los errores de compilación en el margen izquierdo del editor
...
T1 preguntó:
dónde se marcan los errores de compilación en el margen izquierdo del editor
Cerrado de T1:
encontré el mecanismo: los errores de compilación se marcan en el margen izquierdo mediante la función line gutter marker en editor panel que consulta line diagnostic marker from map esta última itera sobre los diagnostics de la línea obtenidos vía diagnostics for editor line y devuelve el carácter si encuentra un k Error el cual es renderizado en el gutter.

T2 preguntó:
dónde se leen los errores de compilación de la consola inferior para añadirlos a los diagnostics del editor
Cerrado de T2:
leído: diagnostics for editor line, diagnostics on line
