...
1. [en_curso] A locator: dónde se crea el marcador de diagnóstico en el margen del editor al recibir un error
2. [pendiente] B locator: dónde se parsean los errores de compilación de la consola para generar diagnósticos
3. [pendiente] P puente: hay camino el parseo de errores de consola y la creación del marcador en el margen (need A B)
...
T3 preguntó:
dónde se pinta el indicador de error en el margen del editor al recibir un diagnóstico
Cerrado de T3:
El hijo cerró esta pregunta: no hay objeto. No se relanza.
leído: line gutter marker, gutter buffer line at row

T4 preguntó:
dónde se crea el marcador de diagnóstico en el margen del editor al recibir un error
Cerrado de T4:
encontré el mecanismo: el marcador se crea en line gutter marker que es invocado desde el bucle de pintura de Make Editor Panel línea 7310 para cada línea del viewport; este función delega en line diagnostic marker from map para obtener el carácter o W basado en los diagnósticos.
