...
2. [fallo] B locator: dónde se limpia el archivo para evitar que quede a medias al cancelar la generación
...
T2 preguntó:
dónde se limpia el archivo para evitar que quede a medias al cancelar la generación
Cerrado de T2:
ESA pregunta no se relanza. Lo leído no era el disparo. PROHIBIDO el mismo claim. do=cerrar ese mapeo. Si el ancla pedía más, un objeto distinto del pack; no el mismo claim en otro keep; no refutes el claim entero.
leído: cancel current, clear pending insert, cancel all, handle user input, cancel level1
...
Esa pregunta ya se contestó. do=cerrar ese mapeo. PROHIBIDO plan u otro explorar del mismo objeto. Ya se tiró: «dónde se limpia el archivo para evitar que quede a medias al cancelar la generación». Rechazado: dónde se captura la tecla Escape o el clic fuera para cancelar la generación de la IA
