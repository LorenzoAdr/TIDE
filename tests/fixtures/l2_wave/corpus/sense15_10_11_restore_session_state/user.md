...
1. [paso] A locator: dónde se restaura la lista de archivos abiertos al volver a abrir un proyecto
2. [en_curso] B locator: dónde se restaura la visibilidad de los paneles laterales al volver a abrir un proyecto (hacia layout)
3. [pendiente] P puente: hay camino restaurar archivos abiertos y restaurar visibilidad de paneles (need A B)
