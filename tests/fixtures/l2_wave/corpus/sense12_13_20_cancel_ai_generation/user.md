...
no encontré la captura de Escape clic para cancelar la generación de IA; lo leído es una función de escape de strings ai trace escape que no tiene relación con eventos de UI ni cancelación de procesos
Abierto:
