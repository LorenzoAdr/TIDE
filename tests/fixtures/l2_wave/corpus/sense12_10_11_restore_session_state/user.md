...
keep: M1
leído: Cursor Pos, context menu open editor background, context menu open editor symbol, open file impl
Cerrado:
leído: Cursor Pos, context menu open editor background, context menu open editor symbol, open file impl
Abierto:
- handle editor mouse
...
### Trabajo 3
consulta: dónde se restaura la selección del cursor al abrir un archivo desde el historial
keep: M1
leído: Cursor Pos, editor state hpp, open file impl, context menu open editor background, context menu open editor symbol, open file at impl, open file at confirmed, reset to single cursor
Cerrado:
encontré el mecanismo de restauración: open file at confirmed llama a open file at impl, que invoca buffer reset to single cursor line, col para establecer la posición del cursor al abrir un archivo con coordenadas ej. desde historial .
Abierto:
- handle editor mouse
...
T2
    visto: Cursor Pos, context menu open editor background, context menu open editor symbol, open file impl
    extra: cursor selection span on line, ensure cursors

T3
    visto: Cursor Pos, editor state hpp, open file impl, context menu open editor background
    extra: cursor selection span on line, ensure cursors
...
T3 preguntó:
dónde se restaura la selección del cursor al abrir un archivo desde el historial
Cerrado de T3:
encontré el mecanismo de restauración: open file at confirmed llama a open file at impl, que invoca buffer reset to single cursor line, col para establecer la posición del cursor al abrir un archivo con coordenadas ej. desde historial .
...
El plan son 2–4 fases (locator / puente / seguir), no un locator por cada objeto del ancla. Recorta a 2–4 o lanza un explorar del fenómeno. El runtime no redacta la consulta.
