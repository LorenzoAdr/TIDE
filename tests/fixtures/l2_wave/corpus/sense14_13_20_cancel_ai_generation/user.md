...
1. [fallo] A locator: dónde se captura la tecla Escape o el clic fuera para interrumpir la generación de código
...
T1 preguntó:
dónde se captura la tecla Escape o el clic fuera para interrumpir la generación de código
Cerrado de T1:
...
Esa pregunta ya se contestó. do=cerrar ese mapeo. PROHIBIDO plan u otro explorar del mismo objeto. Ya se tiró: «dónde se limpia el archivo parcialmente escrito al cancelar la generación». Rechazado: dónde se captura la tecla Escape o el clic fuera para interrumpir la generación de código
