...
keep: M1
leído: Cursor Pos, Editor Text, Make Editor Panel
Cerrado:
...
keep: M1
leído: context menu open editor background, context menu open editor symbol, open file at impl, open file confirmed
Cerrado:
El hijo cerró esta pregunta: no hay objeto. Está contestada. No se relanza.
...
T1
    visto: Cursor Pos, Editor Text, Make Editor Panel
    extra: cursor selection span on line, ensure cursors

T2
    visto: context menu open editor background, context menu open editor symbol, open file at impl, open file confirmed
