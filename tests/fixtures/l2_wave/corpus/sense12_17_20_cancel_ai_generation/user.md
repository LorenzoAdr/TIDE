...
T1 preguntó:
dónde se cancela la generación de la IA al pulsar Escape
Cerrado de T1:
ESA pregunta no se relanza. Lo leído no era el disparo. PROHIBIDO el mismo claim. do=cerrar ese mapeo.
no encontré la cancelación por tecla Escape; lo leído muestra que la cancelación se activa solo por comandos de texto cancel, cancel, cancelar en handle user input, sin lógica de detección de la tecla Escape
...
Esa pregunta ya tiene respuesta (no hay objeto). No la relances. PROHIBIDO plan u otro explorar con el mismo claim. do=cerrar citando lo leído. Ya se tiró: «dónde se cancela la generación de la IA al pulsar Escape». Rechazado: dónde se intercepta la tecla Escape para cancelar la generación de la IA
