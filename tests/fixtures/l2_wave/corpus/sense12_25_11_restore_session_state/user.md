...
1. [en_curso] A locator: dónde se guarda y restaura la posición del cursor al abrir un proyecto
2. [pendiente] B locator: dónde se guarda y restaura la lista de archivos abiertos al abrir un proyecto
3. [pendiente] C locator: dónde se guarda y restaura la visibilidad de los paneles laterales al abrir un proyecto
4. [pendiente] P puente: hay un único mecanismo que restaura cursor, archivos y paneles al cargar la sesión (need A B C)
