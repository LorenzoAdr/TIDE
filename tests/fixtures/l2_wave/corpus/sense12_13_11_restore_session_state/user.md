...
1. [en_curso] A locator: dónde se restaura la posición del cursor al abrir un archivo guardado
2. [pendiente] B locator: dónde se restauran los archivos abiertos al reabrir el proyecto
3. [pendiente] C locator: dónde se restaura la visibilidad de los paneles laterales al reabrir el proyecto
4. [pendiente] P puente: hay un mecanismo común que restaura el estado completo cursor, archivos, paneles al cargar la sesión (need A B C)
...
T3 preguntó:
dónde se escribe la posición del cursor al salir del editor
Cerrado de T3:
leído: Cursor Pos, editor state hpp
