...
1. [en_curso] A locator: dónde se parsean los errores de compilación del texto de la consola para extraer la línea y el mensaje
2. [pendiente] B locator: dónde se publican los diagnostics al editor para que aparezcan en el margen
3. [pendiente] P puente: hay camino el parser de errores de la consola y la publicación de diagnostics en el editor (need A B)
