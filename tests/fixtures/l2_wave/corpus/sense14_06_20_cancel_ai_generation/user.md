...
1. [paso] A locator: dónde se captura la tecla Escape o el clic fuera para cancelar la generación de código
2. [fallo] B locator: dónde se limpia el archivo a medias al cancelar la generación
3. [pendiente] P puente: hay camino capturar Escape clic fuera y limpiar el archivo a medias (need A B)
...
control: do no legal ahora (no_pasar) Legal ahora: explorar, plan, cerrar
