...
hunks=1 edit_attempt=1

#### hunk 1 `src/ui/main_layout.hpp` @116
...
attempt: 1/3  exit_code: 0

```
… (showing last 12 of 199 lines)
...
### fresh `src/ui/console_panel.cpp:main_layout`

```
src/ui/console_panel.cpp:1-3440 (main_layout) [TRUNCATED]
symbol_span: 1-3440
sent: 1-3440
...
### fresh `src/ui/console_panel.hpp:main_layout`

```
src/ui/console_panel.hpp:1-44 (main_layout)
symbol_span: 1-44
#pragma once
