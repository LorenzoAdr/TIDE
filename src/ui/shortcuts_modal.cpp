      ...
      {i18n::tr("shortcuts.section.general"),
       {
           ...
           {"Ctrl+Alt+E", i18n::tr("shortcuts.general.open_external_here")},
      ...
      {i18n::tr("shortcuts.section.editor"),
       {
           ...
           {"Ctrl+A", i18n::tr("shortcuts.editor.select_all")},
           ...
           {"Ctrl+Alt+. / Ctrl+Alt+/", i18n::tr("shortcuts.editor.complete_recommended")},
      ...
      {i18n::tr("shortcuts.section.helix"),
       {
           ...
           {"F6", i18n::tr("shortcuts.general.helix_toggle")},
           {i18n::tr("shortcuts.key.alt_helix"), i18n::tr("shortcuts.helix.overlay")},
       }},
