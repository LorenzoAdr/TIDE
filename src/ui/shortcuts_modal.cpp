      ...
      {"General",
       {
           ...
           {"Alt+← / →", "Mover foco izquierda / derecha"},
      ...
      {"Editor",
       {
           ...
           {"Ctrl+D", "Media página abajo (cursor + scroll)"},
           {"Ctrl+Backspace", "Borrar palabra anterior"},
           {"Ctrl+Delete", "Borrar palabra siguiente"},
           {"Ctrl+Shift+D", "Seleccionar siguiente coincidencia"},
      ...
      {"Depuración",
       {
           ...
           {"Ctrl+D", "Scroll media página abajo"},
