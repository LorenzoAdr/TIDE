      ...
      {"General",
       {
           ...
           {"Ctrl+Shift+S", "Panel de símbolos de binario (nm)"},
      ...
      {"Editor",
       {
           ...
           {"Alt+.", "Completar código (recomendado)"},
           {"F6 / Ctrl+.", "Completar código (LSP)"},
           {"Ctrl+Mayús+Espacio", "Completar código (si Ctrl+Espacio no funciona)"},
           {"Al escribir", "Autocompletado automático (F10 para activar/desactivar)"},
