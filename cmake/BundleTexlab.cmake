...
set(TGDB_CHKTEX_DEB_NAME "chktex_${TGDB_CHKTEX_VERSION}_amd64.deb")
set(TGDB_CHKTEX_DEB_URL
    "https://deb.debian.org/debian/pool/main/c/chktex/${TGDB_CHKTEX_DEB_NAME}")
set(TGDB_CHKTEX_DEB_PATH "${TGDB_BUNDLED_CACHE_DIR}/${TGDB_CHKTEX_DEB_NAME}")
set(TGDB_PCRE2_POSIX_DEB_NAME "libpcre2-posix3_${TGDB_PCRE2_VERSION}_amd64.deb")
set(TGDB_PCRE2_POSIX_DEB_URL
    "https://deb.debian.org/debian/pool/main/p/pcre2/${TGDB_PCRE2_POSIX_DEB_NAME}")
set(TGDB_PCRE2_POSIX_DEB_PATH "${TGDB_BUNDLED_CACHE_DIR}/${TGDB_PCRE2_POSIX_DEB_NAME}")
set(TGDB_PCRE2_8_DEB_NAME "libpcre2-8-0_${TGDB_PCRE2_VERSION}_amd64.deb")
set(TGDB_PCRE2_8_DEB_URL
    "https://deb.debian.org/debian/pool/main/p/pcre2/${TGDB_PCRE2_8_DEB_NAME}")
set(TGDB_PCRE2_8_DEB_PATH "${TGDB_BUNDLED_CACHE_DIR}/${TGDB_PCRE2_8_DEB_NAME}")
...
add_custom_command(
  ...
  COMMAND "${CMAKE_COMMAND}" -E env
          ...
          TGDB_CHKTEX_VERSION="${TGDB_CHKTEX_VERSION}"
          TGDB_CHKTEX_DEB_NAME="${TGDB_CHKTEX_DEB_NAME}"
          TGDB_CHKTEX_DEB_URL="${TGDB_CHKTEX_DEB_URL}"
          TGDB_CHKTEX_DEB_PATH="${TGDB_CHKTEX_DEB_PATH}"
          TGDB_PCRE2_VERSION="${TGDB_PCRE2_VERSION}"
          TGDB_PCRE2_POSIX_DEB_NAME="${TGDB_PCRE2_POSIX_DEB_NAME}"
          TGDB_PCRE2_POSIX_DEB_URL="${TGDB_PCRE2_POSIX_DEB_URL}"
          TGDB_PCRE2_POSIX_DEB_PATH="${TGDB_PCRE2_POSIX_DEB_PATH}"
          TGDB_PCRE2_8_DEB_NAME="${TGDB_PCRE2_8_DEB_NAME}"
          TGDB_PCRE2_8_DEB_URL="${TGDB_PCRE2_8_DEB_URL}"
          TGDB_PCRE2_8_DEB_PATH="${TGDB_PCRE2_8_DEB_PATH}"
  ...
  COMMENT "Preparing embedded TexLab ${TGDB_TEXLAB_VERSION} + ChkTeX ${TGDB_CHKTEX_VERSION}"
  VERBATIM)
